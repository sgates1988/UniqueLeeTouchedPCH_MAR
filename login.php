...
if (isset($_POST['empUsername'])) {
    ...
    $sql = "SELECT emp_firstname, emp_lastname FROM employees WHERE emp_username='$myusername' and emp_password='$mypassword'";
    ...
    if ($count == 1) {
        ...
        echo "<p style=' float:right; position:relative; padding-left:10px; padding-right:10px; color:black; border-bottom: 6px solid red; background-color: lightgrey; width:200px;' > Incorrect Username or Password. Please try again!</p>";
include('index.php');
    }
} else {
    include('index.php');
